...
class WebWeixin(object):
	...
	# def instapaper(self, url):
	# 	ipaper = instapaper.Instapaper('4316ef7422ec43b6b9a991247eafc4f1', '79fd8bb7888d43f489279d98ab830db4')
	# 	ipaper.login('705676521@qq.com', 'wode0408.')
	...
	def handleMsg(self, r):
		for msg in r['AddMsgList']:
			...
			if msgType == 1:
				...
				self.messageHandle(msgBox, content, name)
				...
				# if appMsgType[msg['AppMsgType']] == 5:
				self.storeTheSharingInBox(msg['FileName'], msg['Url'], msgBox)
